...
public class IPVStubExtension extends HttpStubExtension {
    ...
    public void init(String internalCommonSubjectId) {
        register(
                "/token",
                200,
                "application/json",
        ...
        register(
                ...
                "application/json",
                "{"
                        + String.format("  \"sub\": \"%s\",", internalCommonSubjectId)
                        + "  \"vot\": \"P2\","
    ...
    public void initWithValidLoCAndReturnCode(String internalCommonSubjectId) {
        register(
                "/token",
                200,
                "application/json",
    ...
    public void initWithInvalidLoCAndReturnCode(String internalCommonSubjectId) {
        register(
                "/token",
                200,
                "application/json",
